...
describe("Testsuite for RingQueue", () => {
    test("Initialization should throw on negative capacity", () => {
        expect(() => new src_1.RingQueue(-1)).toThrow();
        expect(() => new src_1.RingQueue(-42)).toThrow();
        expect(() => new src_1.RingQueue(-1001)).toThrow();
    });
    test("Initialization should throw on zero capacity", () => {
        expect(() => new src_1.RingQueue(0)).toThrow();
    });
    test("Initialization should not throw on positive capacity", () => {
        expect(() => new src_1.RingQueue(1)).not.toThrow();
        expect(() => new src_1.RingQueue(42)).not.toThrow();
        expect(() => new src_1.RingQueue(1001)).not.toThrow();
    });
    test("Add should add an element to the queue", () => {
        const queue = new src_1.RingQueue(42);
        queue.add(1);
    ...
    test("Length should be zero on initialization", () => {
        expect(new src_1.RingQueue(1).length()).toBe(0);
        expect(new src_1.RingQueue(42).length()).toBe(0);
        expect(new src_1.RingQueue(1001).length()).toBe(0);
    });
    ...
    test("Is empty should be true on initialization", () => {
        expect(new src_1.RingQueue(1).isEmpty()).toBe(true);
        expect(new src_1.RingQueue(42).isEmpty()).toBe(true);
        expect(new src_1.RingQueue(1001).isEmpty()).toBe(true);
    });
    ...
    test("Peek should return undefined on initialization", () => {
        expect(new src_1.RingQueue(1).peek()).toBeUndefined();
        expect(new src_1.RingQueue(42).peek()).toBeUndefined();
        expect(new src_1.RingQueue(1001).peek()).toBeUndefined();
    });
    ...
    test("Read should return undefined on initialization", () => {
        expect(new src_1.RingQueue(1).read()).toBeUndefined();
        expect(new src_1.RingQueue(42).read()).toBeUndefined();
        expect(new src_1.RingQueue(1001).read()).toBeUndefined();
    });
...
//# sourceMappingURL=ring_queue.test.js.map